        ...
        <div className='div_paper'>
          <section className='section_header'>
            <div className='section_avatar'>
              <Avatar className='avatar' alt='Gabriela Gontijo' src={avatarGabi} sx={{ width: 210, height: 210 }} />
            </div>

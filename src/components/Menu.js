        ...
        <section className='section_menu'>
          <div>
            ...
            <MenuItem className='item_menu'>
              ...
              <a href="https://gabigontijo.github.io/portfolio/#/dev" rel='noreferrer'>
                Home
              </a>
            </MenuItem>
            <MenuItem className='item_menu'>
              <FilterIcon sx={{ fontSize: '2rem', color: 'var(--title-color)' }} />
              <a href="https://gabigontijo.github.io/portfolio/" rel='noreferrer'>
                Exhibition
              </a>
            </MenuItem>
            <MenuItem className='item_menu'>
          ...
          <div>
            ...
            <MenuItem className='item_menu' onClick={copyToClipboard}>
              <MailOutlineIcon sx={{ fontSize: '2rem', color: 'var(--title-color)' }} />
              <p>dev.gabigontijo@gmail.com</p>
            </MenuItem>
            <MenuItem className='item_menu' onClick={copyToClipboard}>
              <PhoneIcon sx={{ fontSize: '2rem', color: 'var(--title-color)' }} />
              <p>+351 915-204-569</p>
            </MenuItem>
            <MenuItem className='item_menu'>
              <HomeIcon sx={{ fontSize: '2rem', color: 'var(--title-color)' }} />
              <a

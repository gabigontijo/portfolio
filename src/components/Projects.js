      ...
      <div className='Projects_main_div'>
        ...
        <div className='Projects_div'>
          <article className='Projects_articles'>
            <a href='https://github.com/gabigontijo/Projeto-Trivia' target='_blank' rel='noreferrer'>
          ...
          <article className='Projects_articles'>
            <a href='https://github.com/gabigontijo/App-Recipes' target='_blank' rel='noreferrer'>
              <img src={tastyRecipes} alt='project tasty recipes' />
            </a>
            <h3>Tasty Recipes</h3>
            <p>Recipes app was developed, using tools from the React ecosystem: Hooks and Context API.</p>
            <ul>
              <li>
                <a href='https://github.com/gabigontijo/App-Recipes' target='_blank' rel='noreferrer'>
                  More
          ...
          <article className='Projects_articles'>
            <a href='https://github.com/gabigontijo/Trybesmith' target='_blank' rel='noreferrer'>
              <img src={trybesmith} alt='project trybesmith' />
            </a>
            <h3>Trybesmith</h3>
            <p>
              {' '}
              CRUD API for a store of medieval items is developed using Typescript, Node, Express, MySQL DB and JWT authentication for
              login.
            </p>
            <ul>
              <li>
          ...
          <article className='Projects_articles'>
            <a href='https://github.com/gabigontijo/Trybers-and-Dragons' target='_blank' rel='noreferrer'>
              <img src={trybeAndDragons} alt='project trybe and dragons' />
            </a>
            <h3>Trybe And Dragons</h3>
            <p>Project to study OOP and SOLID architecture based on RPG D&D theme with Node.js and Typescript.</p>
            <ul>
              <li>
                <a href='https://github.com/gabigontijo/Trybers-and-Dragons' target='_blank' rel='noreferrer'>
                  More
